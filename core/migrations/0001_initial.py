# Generated by Django 3.0.5 on 2020-05-23 11:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Patient'), (2, 'Doctor'), (3, 'HR'), (4, 'Receptionist')], null=True)),
        ...
        migrations.CreateModel(
            name='Prescription',
            fields=[
                ('complaint', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.Complaint')),
                ('Date', models.DateTimeField(auto_now=True)),
                ('Description', models.TextField()),
